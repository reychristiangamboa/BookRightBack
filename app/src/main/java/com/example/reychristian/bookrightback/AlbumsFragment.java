...
public class AlbumsFragment extends Fragment {
    ...
    private FloatingActionMenu fam_albums;
    private FloatingActionButton fab_add_album;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fam_albums = (FloatingActionMenu) view.findViewById(R.id.fam_albums);
        fab_add_album = (FloatingActionButton) view.findViewById(R.id.fab_add_album);
...
//        prepareBooks();
        ...
        fab_add_album.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AddAlbumDialog aad = new AddAlbumDialog();
